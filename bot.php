...
while (true) {
	...
	$var_teks = $waktu_sekarang." EC = ".$warna_isi_kuning_terang.$var_untuk_fungsi_parsing_html_ec.$warna_reset." | PAYOUT = ".$warna_isi_hijau_terang.$var_untuk_fungsi_parsing_html_claim.$warna_reset." | TOKEN = ".$warna_isi_merah_terang.$var_untuk_fungsi_parsing_html_cp.$warna_reset;
	echo $var_teks;
